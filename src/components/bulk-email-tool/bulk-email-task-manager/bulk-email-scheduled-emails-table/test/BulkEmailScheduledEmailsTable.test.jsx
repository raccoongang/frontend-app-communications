...
import {
  render, screen, cleanup, fireEvent, initializeMockApp, waitFor,
} from '../../../../../setupTest';
...
describe('BulkEmailScheduledEmailsTable', () => {
  ...
  it('properly renders scheduled emails', async () => {
    ...
    await waitFor(() => {
      expect(screen.findByText('learners')).toBeTruthy();
      expect(screen.findByText('subject')).toBeTruthy();
      expect(screen.findByText('edx')).toBeTruthy();
      expect(screen.findByLabelText('View')).toBeTruthy();
    });
  });
